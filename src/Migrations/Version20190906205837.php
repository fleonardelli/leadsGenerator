 ...
 */
final class Version20190906205837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tematic_area (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE academic_offer (id INT AUTO_INCREMENT NOT NULL, tematic_area_id INT NOT NULL, offer_type_id INT NOT NULL, institution_id INT NOT NULL, name VARCHAR(255) NOT NULL, duration DOUBLE PRECISION DEFAULT NULL, time_table VARCHAR(255) DEFAULT NULL, course_place VARCHAR(255) NOT NULL, description VARCHAR(1000) DEFAULT NULL, active TINYINT(1) NOT NULL, INDEX IDX_DD9EEAFB3270A09 (tematic_area_id), INDEX IDX_DD9EEAFB64444A9A (offer_type_id), INDEX IDX_DD9EEAFB10405986 (institution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE institution (id INT AUTO_INCREMENT NOT NULL, institution_type_id INT NOT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, lead_price DOUBLE PRECISION NOT NULL, active TINYINT(1) NOT NULL, INDEX IDX_3A9F98E5A1B27A01 (institution_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course_mode (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `lead` (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, academic_offer_id INT NOT NULL, from_portal VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, got_from_crm TINYINT(1) NOT NULL, sent_by_email TINYINT(1) NOT NULL, INDEX IDX_289161CBCB944F1A (student_id), INDEX IDX_289161CB6CF6FCF9 (academic_offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bill (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, leads_count INT NOT NULL, lead_price DOUBLE PRECISION NOT NULL, payment_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
